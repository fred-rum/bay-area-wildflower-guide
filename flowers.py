...
def sort_pages(page_set, color=None, demote_auto=False):
    ...
    # helper function to sort keys and observed flowers above
    # auto-generated family lists and unobserved flowers.
    def key_demote_auto(page):
        if (page.autogenerated or
            not (page.jpg_list or page.child)):
            return 1 # later in the list
        else:
            return 0 # earlier in the list
    ...
    if demote_auto:
        page_list.sort(key=key_demote_auto)
    return page_list
